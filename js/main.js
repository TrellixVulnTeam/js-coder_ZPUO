...
// class Simulador {
//     // constructor(capital, plazo, interes) {
...
// btnCalcular.addEventListener('click', () => {
//     simulacion.calcularCuota(monto.value, interes.value, tiempo.value);
// });


const tabla = document.getElementById('lista-tabla')
const head = tabla.querySelectorAll('tr')

// const selectCuota = prompt('Elija la cuota a calcular')
